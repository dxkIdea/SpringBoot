...
//注：PageHelper不要使用5.0以上版本，因为5.0以上没实现Interceptor接口，导致SqlSessionFactoryBean添加插件时，失败）
@Configuration  
@AutoConfigureAfter(DataSourceConfig.class)  
@EnableTransactionManagement
@MapperScan("com.spring.study.mapper")//扫包
       ...
       /* @Value("${mybatis.configLocation}")  
        ...
        public SqlSessionFactory sqlSessionFactory() {  
            try {  
                ...
                //实体
                sessionFactoryBean.setTypeAliasesPackage("com.spring.study.entity");
                
                // 读取配置   
                sessionFactoryBean.setTypeAliasesPackage("com.spring.study.mapper");  
